...
face_cascade = cv2.CascadeClassifier('/home/mdo2/tensorflow/lib/python3.5/site-packages/cv2/data/haarcascade_frontalface_default.xml')
...
for i in range(start,end):
    ...
    os.system('mkdir -p ' + path + '/Video/s'+str(i))
    ...
    os.system('mkdir -p ' + path + '/Video/s' + str(i) + '/face')
    os.system('mkdir -p ' + path + '/Video/s' + str(i) + '/frames')
    ...
    for j in range(1,numfiles+1):
        ...
        #out = cv2.VideoWriter(source_path + 'face/'+str(format_num1)+'.avi', fourcc, 25.0, (128,128))
        ...
        #stabilizing video
        #os.system('ffmpeg -i '+ source_path + str(format_num1)+'.mpg' +' -vf vidstabdetect -f null -')
        #os.system('ffmpeg -i '+ source_path + str(format_num1)+'.mpg' +' -vf vidstabtransform=smoothing=5:input="transforms.trf" '+ 's_'+str(format_num1)+'.mpg' )
...
for i in range(start,end):
    ...
    print(i)
    os.system('mkdir -p '+ path +'/Audio/s'+str(i))
